...
exports.check = () => {
    ...
    // List for download (update) found
    autoUpdater.on('update-available', () => {
        ...
        dialog.showMessageBox({
            ...
            message: 'A new version of BCFC-Marker is available. Do you want to update now',
            buttons: ['Update', 'No']
        }, (buttonIndex) => {
            ...
            ipcMain.one('download-progress-request', (e) => {
            ...
            autoUpdater.on('update-downloaded', () => {
                ...
                dialog.showMessageBox({
                    type: 'info',
                    title: 'Update Ready',
                    message: 'A new version of BCFC Marker is ready. Quit and install now?',
                    buttons: ['Yes', 'Later']
                }, (buttonIndex) => {
                    // Update if 'Yes'
